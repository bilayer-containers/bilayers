...
def generate(
    ...
    jupyter_app_code = generate_jupyter_notebook(jupyter_template_path, "jupyter_template.py.j2", inputs, outputs, parameters, display_only, exec_function, citations)
