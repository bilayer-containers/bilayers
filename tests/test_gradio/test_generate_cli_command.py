# This file should (maybe in future) test the functional part of the CLI command generation for Gradio Interface.
# Use the test cases file from tests/test_algorithm/correct_validation_config.yaml
